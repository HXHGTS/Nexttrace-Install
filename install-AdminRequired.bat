...
curl --doh-url https://dns.alidns.com/dns-query -fsSL https://github.com/HXHGTS/ipinfo-mmdb/releases/latest/download/ipinfoLocal.mmdb -o %WINDIR%\ipinfoLocal.mmdb
